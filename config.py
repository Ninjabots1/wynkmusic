...
LOGGER_ID = int(getenv("LOGGER_ID", "-1002035785639"))
BOTADDLOGS = int(getenv("BOTADDLOGS", "-1002035785639")) # LOGGER_ID Id Also Use No Problem
GBAN_LOGS = int(getenv("GBAN_LOGS", "-1002035785639"))
GCAST_USERS = list(map(int, getenv("GCAST_USERS", "6515982629").split()))
OWNER_ID = int(getenv("OWNER_ID", 6515982629))
OWNER = int(getenv("OWNER", 6515982629))
OWNER_USERNAME = getenv("OWNER_USERNAME","ll_NINJA_XDZ_ll")
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME")
HEROKU_API_KEY = getenv("HEROKU_API_KEY")
UPSTREAM_REPO = getenv("UPSTREAM_REPO","https://github.com/Ninjabots1/wynkmusic")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "main")
GIT_TOKEN = getenv("GIT_TOKEN",None)
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/+lRMjYBcCt3tjN2E1")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/+lRMjYBcCt3tjN2E1")
...
START_IMG_URL = getenv("START_IMG_URL", "https://graph.org/file/0f457306c9675f08e1779.jpg")
PING_IMG_URL = getenv("PING_IMG_URL", "https://graph.org/file/91726bdaa436d175388ce.jpg")
